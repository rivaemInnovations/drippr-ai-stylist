...
/* ------------------------------------------------------------------ */
/*  Collection title mappings (Step 3 → vibe, Step 4 → category)       */
/* ------------------------------------------------------------------ */

/**
 * Maps Step 3 vibe UI labels to their exact Shopify collection TITLES.
 * We search by title (not handle) because handles can be unpredictable
 * if the store owner renamed a collection after creation.
 */
export const VIBE_COLLECTION_TITLES: Record<string, string> = {
...
/**
 * Maps Step 4 category UI labels to their exact Shopify collection TITLES.
 */
export const CATEGORY_COLLECTION_TITLES: Record<string, string> = {
